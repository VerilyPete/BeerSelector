...
with_node \
  ...
  --target "/Users/pete/BeerSelector/ios/Pods/Target Support Files/Pods-BeerSelector/ExpoModulesProvider.swift" \
  --entitlement "/Users/pete/BeerSelector/ios/BeerSelector/BeerSelector.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-sqlite" "expo-symbols" "expo-system-ui" "expo-web-browser"
