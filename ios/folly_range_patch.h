#ifndef FOLLY_RANGE_PATCH_H
#define FOLLY_RANGE_PATCH_H

// Add std::char_traits<unsigned char> implementation
#include <string>
...
// Patch for Folly Range.h to work with unsigned char without string_view
#define FOLLY_HAS_STRING_VIEW 0

#endif // FOLLY_RANGE_PATCH_H 